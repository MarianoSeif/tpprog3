...
class AccesoDatos
{
    ...
    {
        try {
            // $this->objetoPDO = new PDO('mysql:host=localhost;dbname=tpprog3;charset=utf8', 'mfs', 'mariano81', array(PDO::ATTR_EMULATE_PREPARES => false, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
